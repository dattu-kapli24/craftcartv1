    ...
    configureServer(server) {
      ...
      server.middlewares.use((req, res, next) => {
        ...
        if (pathname === "/admin" || pathname === "/admin/") {
          ...
          res.writeHead(302, { Location: "/store.html" + url.search });
          res.end();
        } else if (pathname === "/collect" || pathname === "/collect/" || pathname === "/orderspot-collect" || pathname === "/orderspot-collect/") {
          res.writeHead(302, { Location: "/collect.html" + url.search });
          res.end();
        } else if (pathname === "/pay" || pathname === "/pay/") {
          res.writeHead(302, { Location: "/pay.html" + url.search });
          res.end();
        } else {
          next();
        }
...
export default defineConfig({
  ...
  plugins: [react(), tailwindcss(), copyStatic(), adminApi()],
});
